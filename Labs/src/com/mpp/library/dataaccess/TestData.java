...
//			person.addCheckoutRecord(allEntries.get(5));
	...
	public void bookData() {
		...
		allBooks.get(0).addBookCopy(new BookCopy(allBooks.get(0), 7, String.valueOf(copyNumber)));
		copyNumber = copyNumberGenerator.nextInt();
		allBooks.get(0).addBookCopy(new BookCopy(allBooks.get(0), 7, String.valueOf(copyNumber)));
		copyNumber = copyNumberGenerator.nextInt();
		allBooks.get(2).addBookCopy(new BookCopy(allBooks.get(2), 21, String.valueOf(copyNumber)));
		copyNumber = copyNumberGenerator.nextInt();
		allBooks.get(2).addBookCopy(new BookCopy(allBooks.get(2), 21, String.valueOf(copyNumber)));
	}
